...
translations = {
    "ru": {
        ...
        "No nanorods matched the selected aspect-ratio and quality criteria. Lower the threshold or allow border-touching rods.": "Ни один наностержень не прошёл выбранные критерии отношения сторон и качества. Снизьте порог или разрешите стержни у границы.",
    ...
    "en": {
        ...
        "No nanorods matched the selected aspect-ratio and quality criteria. Lower the threshold or allow border-touching rods.": "No nanorods matched the selected aspect-ratio and quality criteria. Lower the threshold or allow border-touching rods.",
    ...
    "zh-cn": {
        ...
        "No nanorods matched the selected aspect-ratio and quality criteria. Lower the threshold or allow border-touching rods.": "没有纳米棒符合所选长宽比和质量条件。请降低阈值或允许接触边界的纳米棒。",
    ...
    "zh-tw": {
        ...
        "No nanorods matched the selected aspect-ratio and quality criteria. Lower the threshold or allow border-touching rods.": "沒有奈米棒符合所選長寬比和品質條件。請降低閾值或允許接觸邊界的奈米棒。",
