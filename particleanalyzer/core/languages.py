...
translations = {
    "ru": {
        ...
        "Switches interface labels and future analysis results.": "Переключает язык интерфейса и последующих результатов анализа.",
    ...
    "en": {
        ...
        "Switches interface labels and future analysis results.": "Switches interface labels and future analysis results.",
    ...
    "zh-cn": {
        ...
        "Switches interface labels and future analysis results.": "切换界面标签和后续分析结果的语言。",
    ...
    "zh-tw": {
        ...
        "Switches interface labels and future analysis results.": "切換介面標籤和後續分析結果的語言。",
